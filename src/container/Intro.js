      ...
      return(
        <div className="result-container">
          <ul>
            ...
            <li>Puzzle 2: First location I visit twice is <strong>{awayFromHQ} blocks</strong> away (red)</li>
          </ul>
          <h3>Solution</h3>
          <ul className="result-container">
            <li>
              <h5>Create mapData</h5>
              <small>It's important to turn inputString into useful data.</small>
              <p>"It's a lot easier with UP, DOWN, LEFT, RIGHT instead of just L/R".</p> 
